        ...
        while cap.isOpened():
            ...
            for track in tracks:
                ...
                if track_id not in processed_tracks:
                    cv2.rectangle(frame, (bbox_resized[0], bbox_resized[1]), (bbox_resized[2], bbox_resized[3]), GREEN,
                                  2)
                    ...
                    for line in ocr_results:
                        ...
                        if line and len(line) > 1 and line[1]:
                            text = line[1][0]  # Directly access the first element of the second item
