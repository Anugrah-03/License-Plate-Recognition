...
def initialize_video(video_path='Video_Samples/trafficCam.mp4'):
...
if __name__ == "__main__":
    ...
    # Start monitoring Redis keys in parallel
    start_time = time.time() 
    threading.Thread(target=monitor_redis_keys, args=(PaddleOCR(),), daemon=True).start()  # Pass an instance of PaddleOCR to the thread
    main()
